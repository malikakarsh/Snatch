...
export default function RegisterPage() {
  ...
  const [role, setRole] = useState<'BEARER' | 'BIDDER'>('BIDDER');
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-10 text-center">
          ...
          <p className="text-zinc-500 text-sm">Join Snatch to participate in auctions</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 bg-black/50 border border-white/10 rounded-xl text-white placeholder-zinc-600 text-sm focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/30 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-zinc-200 transition-colors p-1 focus:outline-none focus:text-zinc-200"
                  tabIndex={-1}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`py-3 px-3 rounded-xl border text-sm font-medium transition-all flex flex-col items-center gap-1 ${
                    role === 'BIDDER'
